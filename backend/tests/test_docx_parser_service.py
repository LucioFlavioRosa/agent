...
# Supondo que extract_text_from_docx esteja em backend/services/docx_parser_service.py
from backend.services.docx_parser_service import extract_text_from_docx
