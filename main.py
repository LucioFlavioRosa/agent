...
from backend.app.api.user_agents import router as user_agents_router  # NOVO IMPORT
...
app.include_router(user_agents_router, prefix="/user", tags=["User Agents"])  # NOVO REGISTRO
