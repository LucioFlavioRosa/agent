...
class WorkflowOrchestrator(IWorkflowOrchestrator):
    def __init__(self, job_manager: IJobManager, blob_storage: IBlobStorageService, 
                 ...
                 incremental_orchestrator_service=None):
    ...
    def execute_workflow(self, job_id: str, start_from_step: int = 0) -> None:
        ...
        try:
            ...
            for i, step in enumerate(steps_to_run):
                ...
                print(f"[{job_id}] [DEBUG] Verificando condições para modo incremental: current_step_index={current_step_index}, aplicar_incremental={job_data.get('aplicar_mudancas_incrementalmente')}, gerar_relatorio_apenas={job_data.get('gerar_relatorio_apenas')}")
                ...
                if strategy.should_pause_for_approval(job_info, step):
                    ...
                    return
                step_result = self._execute_step_with_strategy(job_id, job_info, step, current_step_index, previous_step_result, repo_reader, i, start_from_step)
