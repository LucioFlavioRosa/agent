class EpicAndTaskCreationService:
    def __init__(self, azure_boards_service_factory, epico_parser_service, tarefa_parser_service):
        self.azure_boards_service_factory = azure_boards_service_factory
    ...
    def create_epics_and_tasks_from_report(self, job_id, job_info, analysis_report, organization_url, project_name):
        ...
        azure_boards_service = self.azure_boards_service_factory(organization_url, project_name)
