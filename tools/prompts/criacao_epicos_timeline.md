...
## 2. OBJETIVO
Gerar uma **Timeline de Execução (JSON)** baseada no `epicos_report`, respeitando estritamente o limite de capacidade produtiva da fábrica.
...
1.  **ESTRUTURA:**
    * Raiz: `epicos_timeline_report` (Lista de objetos).
