...
## 2. DIRETIVA PRIMÁRIA
Analisar o código-fonte fornecido e gerar um relatório **JSON estruturado**, Foque em problemas críticos ou de alto risco que comprometam o o melhor funcionamento da aplicação.
