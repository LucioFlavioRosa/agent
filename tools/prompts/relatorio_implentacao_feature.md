...
## Exemplo de Especificação de Exclusão

Para remover arquivos, inclua uma linha no plano de ação:

| Passo # | Arquivo a Criar/Modificar | Ação de Implementação Detalhada | Justificativa / Requisito Atendido |
|---|---|---|---|
| 3 | `backend/app/deprecated_module.py` | **EXCLUIR:** Remover módulo obsoleto do sistema. | Remove código legado após migração. |
