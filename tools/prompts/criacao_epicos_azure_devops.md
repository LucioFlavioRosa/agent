...
4.  **ESTRUTURA DA TABELA:** A tabela deve listar **todos os épicos identificados** e ter **exatamente** as seguintes colunas: `ID`, `Épico`, `Objetivo de Negócio`, `Critérios de Aceite / Atividades Chave`, `Perfis Envolvidos`, `Estimativa de Esforço`.
    * Para a coluna `Passos`, use um identificador sequencial simples (ex: `E01`, `E02`).
